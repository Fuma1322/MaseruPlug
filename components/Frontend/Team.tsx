  ...
  const team: TeamMember[] = [
    {
      ...
      role: 'Founder & CEO',
      image: '/stash.jpeg',
      bio: 'Founder and product visionary behind MaseruPlug. Leads the platform strategy, technology development, and mission to build digital infrastructure that helps Lesotho businesses grow online and reach more customers.',
      ...
      linkedin: 'https://www.linkedin.com/in/tankiso-leonard-fuma-2b16352a',
    },

    {
      ...
      role: 'Co-Founder & CTO',
      image: '/chief.jpeg',
      bio: 'Leads MaseruPlug’s technical architecture and engineering direction. Responsible for backend systems, infrastructure, security, and building scalable solutions that support the growth of local businesses.',
      whatsapp: 'https://wa.me/26657294698',
      instagram: 'https://instagram.com/lemohang',
      facebook: 'https://www.facebook.com/share/1HBER4iDLt/',
      linkedin: 'https://www.linkedin.com/in/lemohang-makintane-078b7b24',
    },

    {
      ...
      image: '/chommy.jpeg',
      bio: 'Drives business operations, merchant onboarding, and customer relationships. Ensures businesses joining MaseruPlug receive the support needed to establish and grow their digital presence.',
